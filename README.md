...
### 🔐 [Encryption vs Hashing](encryption_vs_hashing.html)
...
### 📖 [Book Cipher Encryption](book_cipher_encryption.html)
...
### 🔒 [Password Hashing](password_hashing.html)
...
1.  **Start with the theory**: Read [Encryption vs
    Hashing](encryption_vs_hashing.html) first
